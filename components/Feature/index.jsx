...
export default function Feature() {
    return (
        <div className="bg-gray-50 px-4 py-12 font-[sans-serif] text-[#333]">
        <div className="max-w-6xl mx-auto">
          <h2 className="mb-16 text-2xl font-extrabold text-center sm:text-4xl">
          ...
          <div className="grid gap-12 mx-auto lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg">
            <div className="flex p-4 bg-white rounded-md shadow-md">
              <svg
                ...
                fill="currentColor"
                className="w-12 h-12 p-3 mr-6 bg-gray-100 rounded-md shrink-0"
                viewBox="0 0 32 32"
              >
                <path
            ...
            <div className="flex p-4 bg-white rounded-md shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Tailor our product to suit your needs 24/7 customer support for all
                  your inquiries.
                </p>
              </div>
            </div>
