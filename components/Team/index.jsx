...
export default function Team() {
    return (
        <div className="font-[sans-serif] text-[#333] py-14">
            <div className="max-w-3xl mx-auto lg:max-w-5xl">
                ...
                <div className="grid mt-12 lg:grid-cols-4 md:grid-cols-3 gap-x-8 gap-y-10 max-md:justify-center">
                    <div className="border rounded-md overflow-hidden max-w-[280px]">
                        ...
                        <div className="p-4">
                            ...
                            <p className="mt-1 text-xs">Software Engineer</p>
                            <div className="mt-4 space-x-4">
                                <button
                                    type="button"
                                    className="inline-flex items-center justify-center bg-blue-600 border-none rounded-full outline-none w-7 h-7 hover:bg-blue-700 active:bg-blue-600"
                                >
                                    <svg
                    ...
                    <div className="border rounded-md overflow-hidden max-w-[280px]">
                        ...
                        <div className="p-4">
                            ...
                            <p className="mt-1 text-xs">Web Designer</p>
                            <div className="mt-4 space-x-4">
                                <button
                                    type="button"
                                    className="inline-flex items-center justify-center bg-blue-600 border-none rounded-full outline-none w-7 h-7 hover:bg-blue-700 active:bg-blue-600"
                    ...
                    <div className="border rounded-md overflow-hidden max-w-[280px]">
                        ...
                        <div className="p-4">
                            ...
                            <p className="mt-1 text-xs">Software Developer</p>
                            <div className="mt-4 space-x-4">
                                <button
                                    type="button"
                                    className="inline-flex items-center justify-center bg-blue-600 border-none rounded-full outline-none w-7 h-7 hover:bg-blue-700 active:bg-blue-600"
